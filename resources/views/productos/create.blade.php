...
<form action="{{route('productos.store')}}" method="POST" class="bg-white p-6 rounded-xl shadow max-w-xl space-y-4">
    ...
    <div>
        ...
        <input type="number" name="stock" class="w-full mt-1 rounded-lg border-slate-300 focus:border-blue-500 focus:ring-blue-500">
    </div>
    ...
    <div class="flex justify-end gap-2">
        ...
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700" onclick="return confirm('¿Estás seguro de que deseas guardar este producto?')">Guardar</button>
    </div>
